/*
 *  lsm330dlc.c
 *  Device driver for LSM330DLC iNEMO inertial module: 3D accelerometer and 3D gyroscope
 *  Created on: 27/1/13
 *  Authors: Jagun Kwon and Stephen Hailes
 *  jagun.kwon@ucl.ac.uk
 *
 */
...
#define DEBUG 0			// Debug mode is off
